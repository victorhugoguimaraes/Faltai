    ...
    <div className="space-y-4 sm:space-y-5">
      ...
      {materias.map((materia, index) => {
        ...
        return (
          <div
            key={index}
            className="rounded-[1.75rem] border border-white/80 bg-white/85 p-4 shadow-soft backdrop-blur-xl transition-all duration-300 hover:-translate-y-1 hover:shadow-medium sm:p-6"
          >
            <div className="mb-4 flex items-start justify-between gap-3">
              ...
              <div className="ml-2 flex gap-1 sm:gap-2">
                <button
                  ...
                  className="rounded-xl border border-sky-100 bg-sky-50 p-2 text-primary-600 transition-colors hover:bg-primary-100"
                  title="Ver calendário"
                >
                  <FaCalendarAlt size={13} className="sm:w-4 sm:h-4" />
                </button>
                <button
                  onClick={() => handleEdit(index)}
                  className="rounded-xl border border-amber-100 bg-amber-50 p-2 text-warning-600 transition-colors hover:bg-amber-100"
                  title="Editar"
                >
                  <FaEdit size={13} className="sm:w-4 sm:h-4" />
                </button>
                <button
                  onClick={() => handleDelete(index)}
                  className="rounded-xl border border-rose-100 bg-rose-50 p-2 text-danger-600 transition-colors hover:bg-rose-100"
                  title="Excluir"
                >
                  <FaTrash size={13} className="sm:w-4 sm:h-4" />
                </button>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex-1">
                <div className={`h-2.5 ${barBgColor} rounded-full overflow-hidden transition-colors duration-300`}>
                  <div
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-3">
                  ...
                  >
                    <FaMinus size={11} className="sm:w-3.5 sm:h-3.5" />
                  </button>
                  <button
                    onClick={() => handleFaltaChange(index, 1)}
